...
export default function WaterReminder() {
  ...
  return (
    <div className="fixed inset-0 bg-accent flex flex-col items-center justify-center p-6 font-sans z-50">
      
      {/* Icon */}
      <div className="bg-white/60 p-8 rounded-full mb-8 shadow-sm">
        <Droplet size={64} className="text-primary fill-primary" />
      </div>
      ...
      <p className="text-primary-hover/80 text-xl font-medium mb-16 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md mb-12">
        <button 
          ...
          className="flex-1 bg-primary text-white py-5 rounded-full text-xl font-bold flex items-center justify-center gap-3 hover:bg-primary-hover transition-colors shadow-lg active:scale-[0.98]"
        >
      ...
      <div className="flex items-center gap-2 text-primary-hover/70 bg-white/40 px-6 py-3 rounded-full">
        <Volume2 size={24} />
