    ...
    <div className="min-h-screen bg-background font-sans flex flex-col">
      <header className="px-6 md:px-12 py-6 flex justify-between items-center bg-white border-b border-gray-100">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-accent rounded-xl flex items-center justify-center text-primary-hover">
            <Heart size={24} />
          </div>
          <span className="text-2xl font-bold text-primary">MemCall</span>
        </div>
        <div className="flex items-center gap-4">
          <Link to="/login" className="text-primary-hover font-bold hover:text-primary">Sign In</Link>
          <Link to="/signup" className="bg-primary-hover text-white px-6 py-2.5 rounded-full font-bold hover:bg-primary-hover transition-colors shadow-sm">Sign Up</Link>
        </div>
      </header>

      <main className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 text-center relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-20 -left-20 w-64 h-64 bg-accent blur-3xl rounded-full opacity-50 pointer-events-none"></div>
        <div className="absolute bottom-20 -right-20 w-64 h-64 bg-peach blur-3xl rounded-full opacity-50 pointer-events-none"></div>
        ...
        <div className="max-w-3xl relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
            <Link to="/signup" className="w-full sm:w-auto bg-primary-hover text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-primary-hover transition-transform active:scale-95 shadow-lg">
              Get Started Free
            </Link>
            <Link to="/login" className="w-full sm:w-auto bg-white text-primary-hover border-2 border-[#1B4D3E] px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-50 transition-colors shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl w-full z-10 mt-8">
          <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm text-left">
            <div className="w-14 h-14 bg-accent rounded-2xl flex items-center justify-center text-primary-hover mb-6">
              <Brain size={32} />
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm text-left">
            <div className="w-14 h-14 bg-peach rounded-2xl flex items-center justify-center text-[#D97706] mb-6">
              <Bell size={32} />
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm text-left">
            <div className="w-14 h-14 bg-rose rounded-2xl flex items-center justify-center text-[#BE123C] mb-6">
              <Shield size={32} />
            </div>
